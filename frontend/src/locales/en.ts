export const en = {
    translation: {
        ...
        HOW_IT_WORKS: {
            ...
            SUBTITLE: "Simple, transparent, and secure for everyone.",
            STEP_1: {
                TITLE: "Create your profile",
                DESC: "Workers upload credentials; institutions set up facility details."
            },
            STEP_2: {
                TITLE: "Get Matched",
        ...
        AUTH: {
            LOGIN: {
                TITLE: "Welcome Back",
                SUBTITLE: "Log in to connect with opportunities.",
            ...
            FORGOT_PASSWORD_PAGE: {
                ...
                SUCCESS_SUBTITLE: "We've sent you a password reset link",
                SUCCESS_MESSAGE: "If an account exists for <1>{{email}}</1>, you will receive a password reset link shortly.",
                SPAM_NOTE: "Please check your spam folder if you don't see the email.",
            ...
            LAYOUT: {
                ...
                BRANDING_SUBTITLE: "Join the leading network for social work professionals and healthcare institutions.",
                SOCIAL_PROOF: "JOIN 2,000+ SOCIAL WORKERS TODAY.",
                FOOTER: "SECURE • VERIFIED • TRUSTED PLATFORM"
            },
            REGISTER_DIALOG: {
                ...
                WORKER: {
                    TITLE: "Social Worker",
                    DESC: "Find missions and connect with institutions"
                },
                INSTITUTION: {
                    TITLE: "Institution",
                    DESC: "Post missions and hire qualified workers"
                },
                CANCEL: "Cancel"
            },
            REGISTER_INSTITUTION: {
                LAYOUT: {
                    ...
                    COPYRIGHT_SECURE: "© {{year}} {{brand}}. Secure & Verified."
                },
                STEP_ACCOUNT: {
                    TITLE: "Account Credentials",
                    SUBTITLE: "Please enter your official email and create a secure password.",
                    EMAIL_LABEL: "Official Email Address",
                    EMAIL_PLACEHOLDER: "institution@example.com",
                    EMAIL_HELPER: "We'll send a verification link to this email.",
                    ...
                    REQUIREMENT_SPECIAL: "One special symbol"
                },
                STEP_INFO: {
                    TITLE: "Tell us about your Institution",
                    SUBTITLE: "Please provide official details for verification purposes.",
                    INSTITUTION_NAME_LABEL: "Official Institution Name",
                    INSTITUTION_NAME_PLACEHOLDER: "e.g. Hope Community Center",
                    DATE_ESTABLISHED_LABEL: "Date Established",
                    CITY_LABEL: "City",
                    DESCRIPTION_LABEL: "About the Institution",
                    DESCRIPTION_PLACEHOLDER: "Describe your institution's mission, values, and the key services provided...",
                    DESCRIPTION_MAX_CHARS: "Max 500 chars",
                    INFO_BOX_TITLE: "Why we need this?",
                    INFO_BOX_DESC: "This information will be displayed on your public profile and helps social workers find institutions that align with their expertise."
                },
                STEP_CONFIRM: {
                    TITLE: "Review Your Information",
                    SUBTITLE: "Please review your details before submitting. You can go back to make changes if needed.",
            ...
            REGISTER_WORKER: {
                ...
                STEP_ACCOUNT: {
                    TITLE: "Account Credentials",
                    SUBTITLE: "Create your secure login credentials to get started.",
                    EMAIL_LABEL: "Email Address",
                ...
                STEP_PERSONAL: {
                    ...
                    ZIP_CODE_PLACEHOLDER: "12345",
                    INFO_BOX_TITLE: "Privacy First",
                    INFO_BOX_DESC: "Your personal information is kept secure and will only be shared with institutions when you apply for missions."
                },
                STEP_PROFESSIONAL: {
                    TITLE: "Professional Information",
                    SUBTITLE: "Help institutions understand your expertise and experience.",
                    SPECIALITY_LABEL: "Primary Speciality",
                    SPECIALITY_PLACEHOLDER: "Select your main speciality",
                    EXPERIENCE_LABEL: "Years of Experience",
                    EXPERIENCE_PLACEHOLDER: "0",
                    EXPERIENCE_HELPER: "Approximate number of years in this field",
                    DOMAINS_LABEL: "Domains of Intervention",
                    DOMAINS_HELPER: "Select all domains you are comfortable working in",
                    BIO_LABEL: "Professional Bio",
                    BIO_PLACEHOLDER: "Briefly describe your professional background, key skills, and the type of missions you are looking for...",
                    BIO_MAX_CHARS: "Max 2000 chars",
                    INFO_BOX_TITLE: "Stand Out",
                    INFO_BOX_DESC: "A well-written bio helps institutions understand your unique strengths and increases your chances of being selected for missions."
                },
                STEP_EXPERIENCE: {
                    TITLE: "Work Experience",
                    SUBTITLE: "Tell us about your past roles in social work or related fields. This helps institutions understand your expertise.",
                    ADD_NEW: "Add New Experience",
                    JOB_TITLE_LABEL: "Job Title",
                    JOB_TITLE_PLACEHOLDER: "e.g. Social Worker",
                    ORGANIZATION_LABEL: "Organization / Institution",
                    ORGANIZATION_PLACEHOLDER: "e.g. City Community Center",
                    START_DATE_LABEL: "Start Date",
                    END_DATE_LABEL: "End Date",
                    CURRENT_WORK_LABEL: "I currently work here",
                    DESCRIPTION_LABEL: "Description / Key Responsibilities",
                    DESCRIPTION_PLACEHOLDER: "Briefly describe your role, responsibilities, and key achievements...",
                    CANCEL: "Cancel",
                    SAVE: "Save Experience",
                    TIPS_TITLE: "Tips for a strong profile",
                    TIP_1: "List relevant roles starting with the most recent.",
                    TIP_2: "Focus on achievements rather than just duties.",
                    TIP_3: "Mention specific populations you've worked with (e.g., elderly, youth).",
                    EMPTY_STATE: "No experiences added yet. You can skip this step if you're just starting your career."
                },
                STEP_DOCUMENTS: {
                    TITLE: "Upload Verification Documents",
                    SUBTITLE: "To verify your credentials and identity, please upload the following documents. We prioritize your privacy and data security.",
                    SECURE_UPLOAD_TITLE: "Secure Upload",
                    ...
                    CV_DESC: "A recent copy of your CV or Resume to highlight your experience.",
                    UPLOAD_BUTTON: "Upload",
                    REQUIRED: "REQUIRED",
                    OPTIONAL: "OPTIONAL",
                    SUPPORTED_FORMATS: "Supported: PDF only. Max 5MB.",
                    SUPPORTED_FORMATS_CV: "Supported: PDF or DOCX. Max 5MB."
                },
                STEP_CONFIRM: {
                    TITLE: "Review Your Information",
                    SUBTITLE: "Please review your details before submitting. You can go back to make changes if needed.",
                    ...
                    BIO_LABEL: "Professional Bio",
                    EXPERIENCES_LABEL: "Professional Experience",
                    EXPERIENCES_COUNT: "experience(s) added",
