                        ...
                        {[5, 4, 3, 2, 1].map((rating, index) => {
                            ...
                            return (
                                <div key={rating} className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1 h-2.5 bg-muted/40 rounded-full overflow-hidden border border-border/5">
                                        <div 
                                            className="h-full bg-[#3d8d66] transition-all duration-1000 ease-out rounded-full shadow-[0_0_10px_rgba(61,141,102,0.2)]" 
                                            style={{ width: `${percentage}%` }}
                                        />
                                    </div>
                                    <span className="text-xs font-black text-muted-foreground min-w-[36px] text-right">
