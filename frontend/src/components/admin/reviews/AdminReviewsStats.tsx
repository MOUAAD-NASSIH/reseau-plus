...
export function AdminReviewsStats({ stats, totalReviews, isLoading }: AdminReviewsStatsProps) {
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="border-border/60 shadow-sm bg-card/40 backdrop-blur-md rounded-2xl overflow-hidden">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <CardTitle className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
                        {t("ADMIN_REVIEWS.SUMMARY.OVERALL_SCORE")}
                    </CardTitle>
                ...
                <CardContent>
                    ...
                    <div className="mt-4 flex items-center justify-between gap-4">
                        ...
                        <div className="text-[10px] font-bold uppercase text-muted-foreground tracking-wide">
                            <span className="text-foreground">{totalReviews}</span> {t("ADMIN_REVIEWS.SUMMARY.TOTAL_REVIEWS")}
                        </div>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="border-border/60 shadow-sm bg-card/40 backdrop-blur-md rounded-2xl overflow-hidden">
                <CardHeader className="pb-2">
                    <CardTitle className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
                        {t("ADMIN_REVIEWS.SUMMARY.BREAKDOWN")}
                    </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <Card className="border-border/60 shadow-sm bg-card/40 backdrop-blur-md rounded-2xl overflow-hidden">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <CardTitle className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
                        {t("ADMIN_REVIEWS.SUMMARY.POSITIVE_RATE")}
                    </CardTitle>
                ...
                <CardContent>
                    ...
                    <p className="text-[10px] text-muted-foreground mt-4 font-medium leading-relaxed uppercase tracking-wider">
                        {t("ADMIN_REVIEWS.SUMMARY.POSITIVE_DESC")}
                    </p>
                    <div className="mt-4 pt-4 border-t border-border/40 flex items-center gap-2">
                        <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                        <span className="text-[10px] font-bold text-emerald-600 uppercase tracking-tight">+{stats.countThisWeek} {t("ADMIN_REVIEWS.SUMMARY.THIS_WEEK")}</span>
                    </div>
                </CardContent>
            </Card>
        </div>
